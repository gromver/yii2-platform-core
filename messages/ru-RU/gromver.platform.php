...
return [
    ...
    'New password has been saved.' => 'Новый пароль сохранен.',
    'Your password has been changed.' => 'Ваш пароль изменен.',
    'Password reset for {name}.' => 'Сменить пароль на сайте {name}.',
    'For changing your password please follow the <a href="{link}">link</a>' => 'Для смены пароля перейдите по <a href="{link}">ссылке</a>',
    ...
    'This e-mail has been sent by <b>{name}</b>, e-mail <b>{email}</b>' => 'Это письмо отправил <b>{name}</b>, e-mail <b>{email}</b>',
    ...
    'Update User Profile: {name} (ID: {id})' => 'Редактировать профиль пользователя: {name} (ID: {id})',
    'Roles' => 'Роли',
    'Password' => 'Пароль',
    ...
    'User Params: {name} (ID: {id})' => 'Параметры пользователя: {name} (ID: {id})',
    'Deleted' => 'Удален',
    'Inactive' => 'Не активен',
    'Active' => 'Активен',
    ...
    'Email Layout' => 'Шаблон e-mail письма',
    'Sort' => 'Сортировка',
    'Dir' => 'Порядок',
