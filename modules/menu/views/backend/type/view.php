...
/* @var $model gromver\platform\core\modules\menu\models\MenuType */
...
<div class="menu-view">
    ...
    <p>
        ...
        <?= Html::a('<i class="glyphicon glyphicon-th-list"></i> ' . Yii::t('gromver.platform', 'Menu Items'), ['/menu/backend/item/index', 'MenuItemSearch' => ['menu_type_id' => (int)$model->id]], ['class' => 'btn btn-default']) ?>
    </p>
