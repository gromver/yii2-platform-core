...
/* @var $searchModel gromver\platform\core\modules\menu\models\MenuItemSearch */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            /*[
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\gromver\platform\core\modules\menu\models\MenuItem::find()->excludeRoots()->orderBy('lft')->all(), 'id', function($model){
                    /** @var $model \gromver\platform\core\modules\menu\models\MenuItem * /
        ...
        'panel' => [
            ...
            'type' => 'info',
            'before' => Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('gromver.platform', 'Add'), ['create', 'menuTypeId' => $searchModel->menu_type_id], ['class' => 'btn btn-success', 'data-pjax' => '0']),
            'after' =>
