...
<iframe src="<?= \yii\helpers\Url::toRoute(['select', 'MenuItemSearch[link_type]' => \gromver\platform\core\modules\menu\models\MenuItem::LINK_ROUTE]) ?>" id="<?= $iframeId ?>" name="<?= $iframeId ?>" width="100%" height="100%" style="border: none; padding: 0; margin: 0;"></iframe>
