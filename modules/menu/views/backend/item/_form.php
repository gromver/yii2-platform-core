...
<div class="menu-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'menu_type_id', ['wrapperOptions' => ['class' => 'col-sm-9']])->dropDownList(['' => Yii::t('gromver.platform', 'Select ...')] + \yii\helpers\ArrayHelper::map(\gromver\platform\core\modules\menu\models\MenuType::find()->all(),'id', 'title')) ?>
        </div>
        <div class="col-sm-6">
            <?php
...
JS
    ...
    <div class="tab-content">
        <div id="main" class="tab-pane active">
            <?= $form->field($model, 'link_type')->dropDownList(\gromver\platform\core\modules\menu\models\MenuItem::linkTypeLabels()) ?>
