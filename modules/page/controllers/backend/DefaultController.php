...
namespace gromver\platform\core\modules\page\controllers\backend;


use gromver\platform\core\modules\main\models\DbState;
use gromver\platform\core\modules\page\models\Page;
use gromver\platform\core\modules\page\models\PageSearch;
...
class DefaultController extends \gromver\platform\core\controllers\BackendController
{
     ...
     * @return string
     */
    public function actionSelect($route = 'page/frontend/default/view')
    {
        $searchModel = new PageSearch();
     ...
     * @return array
     */
    public function actionPageList($q = null, $exclude = null) {
