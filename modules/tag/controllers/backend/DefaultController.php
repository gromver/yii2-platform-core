...
namespace gromver\platform\core\modules\tag\controllers\backend;


use gromver\platform\core\modules\tag\models\Tag;
use gromver\platform\core\modules\tag\models\TagSearch;
...
class DefaultController extends \gromver\platform\core\controllers\BackendController
{
     ...
     * @return string
     */
    public function actionSelect($route = 'tag/frontend/default/view')
    {
        $searchModel = new TagSearch();
     ...
     * @return array
     */
    public function actionTagList($q = null) {
        \Yii::$app->response->format = Response::FORMAT_JSON;

        $results = Tag::find()->select('id, title AS text')->andFilterWhere(['like', 'title', urldecode($q)])->limit(20)->asArray()->all();
