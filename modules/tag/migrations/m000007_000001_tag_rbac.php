...
class m000007_000001_tag_rbac extends \yii\db\Migration
{
    public function up()
    {
        ...
        // add the rule
        $authorRule = new \gromver\platform\core\modules\tag\rules\AuthorRule();
        $auth->add($authorRule);
    ...
    public function down()
    {
        ...
        $auth->remove($auth->getRule('isTagAuthor'));
    }
}
