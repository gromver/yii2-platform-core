...
class Tag extends \yii\db\ActiveRecord implements ViewableInterface
{
    ...
    {
        return ['/tag/frontend/default/view', 'id' => $this->id, 'alias' => $this->alias];
    }
    ...
    {
        return ['/tag/frontend/default/view', 'id' => $model['id'], 'alias' => $model['alias']];
    }
    ...
    {
        return ['/tag/backend/default/view', 'id' => $this->id];
    }
    ...
    {
        return ['/tag/backend/default/view', 'id' => $model['id']];
    }
}
