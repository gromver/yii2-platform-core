...
namespace gromver\platform\core\modules\version\widgets;
...
class Versions extends \yii\base\Widget
{
    ...
    public function run()
    {
        return \gromver\widgets\ModalIFrame::widget([
            ...
            'url' => ['/version/backend/default/item', 'item_id' => $this->model->getPrimaryKey(), 'item_class' => $this->model->className()]
        ]);
    }
} 