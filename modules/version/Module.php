...
namespace gromver\platform\core\modules\version;
...
{
    public $controllerNamespace = 'gromver\platform\core\modules\version\controllers';
    ...
    public function addDesktopItem($event)
    {
        $event->items[] = [
            ...
            'items' => [
                ['label' => Yii::t('gromver.platform', 'Versions'), 'url' => ['/version/backend/default/index']]
            ]
        ];
    }
