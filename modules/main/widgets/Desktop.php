...
use gromver\platform\core\modules\main\widgets\events\DesktopEvent;
use Yii;
 ...
 * Для сбора списка компонентов используется модульное событие \gromver\platform\core\modules\main\widgets\events\DesktopEvent
 * @package yii2-platform-basic
