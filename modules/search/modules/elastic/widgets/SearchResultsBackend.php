...
namespace gromver\platform\core\modules\search\modules\elastic\widgets;


use gromver\modulequery\ModuleEvent;
use gromver\platform\core\modules\search\modules\elastic\models\Index;
use gromver\platform\core\modules\search\modules\elastic\widgets\events\ElasticBeforeSearchEvent;
use Yii;
...
{
    const EVENT_BEFORE_SEARCH = 'ElasticBeforeBackendSearch_';
    ...
    protected function launch()
    {
        ...
        foreach ($this->models as $modelClass) {
            ModuleEvent::trigger(self::EVENT_BEFORE_SEARCH, new ElasticBeforeSearchEvent([
