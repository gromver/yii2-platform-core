...
namespace gromver\platform\core\modules\search\modules\sql\components;
...
class MenuRouterSearch extends \gromver\platform\core\components\MenuRouter {
    ...
    public function createUrlRules()
    {
        return [
            [
                'requestRoute' => 'grom/search/sql/frontend/default/index',
    ...
    {
        if($path = $requestInfo->menuMap->getMenuPathByRoute('grom/search/sql/frontend/default/index')) {
