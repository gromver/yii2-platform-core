...
namespace gromver\platform\core\modules\search\modules\sql\widgets;


use gromver\modulequery\ModuleEvent;
use gromver\platform\core\modules\search\modules\sql\models\Index;
use gromver\platform\core\modules\search\modules\sql\widgets\events\SqlBeforeSearchEvent;
 ...
 */
class SearchResultsBackend extends \gromver\platform\core\modules\search\widgets\SearchResultsBackend
{
    const EVENT_BEFORE_SEARCH = 'SqlBeforeBackendSearch_';
     ...
     * @editable
     */
    public $itemLayout = '_itemDefaultBackend';
    public $pageSize = 10;
    /**
    ...
    protected function launch()
    {
        ...
        foreach ($this->models as $modelClass) {
            ModuleEvent::trigger(self::EVENT_BEFORE_SEARCH, new SqlBeforeSearchEvent([
    ...
    {
        return [
            '_itemDefaultBackend' => Yii::t('gromver.platform', 'Default'),
        ];
    }
}