...
/* @var $model \gromver\platform\core\modules\search\modules\sql\models\Index */

echo Html::beginTag('div', ['class' => 'search-result-item']);
echo Html::a($this->context->highlightText($model->title), $model->getBackendViewLink(), ['class' => 'h4 title']);
